classdef PrunningLSSVM < handle
   ...
   methods
      ...
      function [train_accuracyVec] = train(obj)
        ...
        i = 0; 
        epsilon = 0.1;
        numberOfPrunedPatterns = 3;
        train_accuracyVec = zeros(2,ceil(size(obj.train_features,1)/numberOfPrunedPatterns));
        ...
        while (i <= size(obj.train_features,1)/numberOfPrunedPatterns)
            ...
            train_accuracyVec(1,i+1) = hit_rate;
            train_accuracyVec(2,i+1) = length(inds);
